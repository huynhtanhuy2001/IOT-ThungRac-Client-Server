...
class BoundBox:
    """
    Class that defines an instances of a bounding box
    Provides easy access to:
      1. label via get_label()
      2. score via get_score

    This, and other associated classes and functions, adapted from:
...
def _softmax(x, axis=-1, t=-100.):
    """
    Softmax function
    Outputs an array of values (probabilities) that sum up to 1.0
